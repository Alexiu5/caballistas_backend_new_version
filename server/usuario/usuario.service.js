...
async function find() {
    try {
        ...
        const query = 'SELECT IC.ID_CLIENTE, IC.NUMERO_DOCUMENTO, IC.NOMBRES, IC.APELLIDOS, US.CORREO FROM INFORMACION_CLIENTE IC INNER JOIN USUARIO_SISTEMA US ON IC.ID_CLIENTE = US.CLIENTE';
...
async function register(params) {
    try {
        const informacionCliente = await InformacionCliente.register(params);
        const usuario = new UsuarioSistema(params.usuario).toArray();
